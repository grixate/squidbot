...
<section>
  ...
  {:else}
    ...
    <section class="panel task-form">
      ...
      <select id="task-priority" name="task_priority" bind:value={newPriority}>
      ...
      <Button.Root type="button" onclick={addTask}>Create Task</Button.Root>
    </section>
              ...
              >
                ...
                <div class="task-actions">
                  ...
                  <Button.Root
                    ...
                    >-&gt;</Button.Root
                  >
                  <Button.Root type="button" onclick={() => deleteTask(task.id)}>Delete</Button.Root>
                </div>
              </article>
            {/each}
          </div>
